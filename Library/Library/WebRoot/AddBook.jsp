...
<form action="BookAction?action=addtemp" onsubmit="return errorsubmit()" method="post">
    <div class="bookinfo">
        ...
        <div>
            <span class="infotitle">书本编号：</span><input class="required" name="bookid" id="bookid" onkeyup="bookcheck()"  ><span id="bookidcheck" class="error"></span>
        </div>
        <div>
        ...
        <div>
            <span class="infotitle">书本价格：</span><input type="text" class="required" name="bookprice" ><span id="bookpricecheck" class="error"></span>
        </div>
        <div>
